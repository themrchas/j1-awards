...
export class AppComponent implements OnInit{
 ...
 //Chart legends
  ...
  //Chart descriptions
  chartDescriptions = {complete:"Average time (in days) of all awards having a valid accepted and completed date such that the completed date is within the past year.",
                       boarding:"Average time (in days) of all complete awards having a valid boarding start and boarding end date such that the completed date is within the past year",
                       qc:"Average time (in days) of all complete awards having a valid QC start and QC end date such that the completed date is within the past year"}
